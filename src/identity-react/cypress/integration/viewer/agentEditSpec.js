context('viewer/Agent edit', function() {
  ...
  describe('authenticated', () => {
    ...
    describe('viewing member agent\'s profile', () => {
      ...
      describe('who is a third-party IdP agent', () => {
      ...
      describe('who is an Auth0-registered agent', () => {

        beforeEach(() => {
          cy.login('someotherguy@example.com', { ..._profile, sub: "auth0|6046c48d1168f10000000000" });
          cy.task('query', `SELECT * FROM "Agents" WHERE "email"='someotherguy@example.com' LIMIT 1;`).then(([results, metadata]) => {
            memberAgent = results[0];
    ...
    describe('viewing your own profile', () => {
      ...
      describe('email verified', () => {
         ...
         *
         * It is expected that most agents will login via a third-party IdP.
         * The test block that follows is for the benefit of Auth0 registered
         * agents
         */
        describe('for third-party IdP agent', () => {
          ...
          //
          // This is more relevant to the Auth0-registered agent tests below.
          // It's left here in case an IdP agent has more fields one day.
          //
         ...
         * 2021-3-17
         *
         * If an agent registers with Auth0, the name field (et al) can be edited
         *
         * Cf., test block above
         */
