context('viewer/Team delete agent', function() {
  ...
  context('authenticated', () => {
    ...
    context('creator agent visit', () => {
      ...
      beforeEach(function() {
        ...
        cy.wait(300);
        // ... adds user
        cy.get('#members-table button span span').contains('add_box').click().then(() => {
          cy.get('#members-table [placeholder="Email"]').type(memberAgent.email);
          cy.get('#members-table button[title="Save"]').click().then(() => {
